...
const PADROES_ITEMS=[{"item":"O trabalho iniciou com a área organizada, cada coisa em seu lugar?","obj":"Garantir partida em condição padrão","crit":"alta"},{"item":"Existe alguma gambiarra no processo?","obj":"Identificar desvios de processo sem solução estruturada","crit":"alta"},{"item":"Todos postos tinham pessoas devidamente capacitadas trabalhando?","obj":"Evitar variação por falta de treinamento","crit":"alta"},{"item":"Existe algum problema em andamento sem solução devidamente encaminhada?","obj":"Fechar ciclo de ação de desvios em aberto","crit":"alta"}];
...
// T2 (meio segundo turno, a partir de 13/abr/2026): +8.8h brutas, +6.8h líquidas
// T3 (terceiro turno, quando aplicável): +8.8h brutas, +6.8h líquidas
const OEE_TEORICO={
  L1:{velNominal:7500,outputH:2945,outputDia:25920,horasOcupadas:8.8,ppH:2,horasLiqT1:6.8,horasLiqT2:6.8,horasLiqT3:6.8},
  L2:{velNominal:3420,outputH:982,outputDia:8640,horasOcupadas:8.8,ppH:2,horasLiqT1:6.8,horasLiqT2:6.8,horasLiqT3:6.8},
  L3:{velNominal:6240,outputH:2273,outputDia:20000,horasOcupadas:8.8,ppH:2,horasLiqT1:6.8,horasLiqT2:6.8,horasLiqT3:6.8}
};

// ── Targets adicionais (configuráveis via config.html) ──
...
let FLOWPACK_PESO={classico:0.8,mini:0.4,zero:0.6,crocante:0.5}; // gramas por flowpack vazio
